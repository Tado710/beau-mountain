(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-facilities")) new swiper_core_Swiper(".slider-facilities", {
            ...
            loop: true,
            pagination: {
                el: ".facilities-navigation__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".facilities-navigation__arrow-prev",
                nextEl: ".facilities-navigation__arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
    ...
    function toggleVideo(e) {
        const parentEl = e.target.closest(".hero__video-player");
        if (parentEl) {
